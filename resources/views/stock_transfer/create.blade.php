			...
			<div class="row">
				...
				<div class="col-sm-6">
					<div class="form-group">
						...
						{!! Form::select('transfer_location_id', $formatted_business_locations, null, ['class' => 'form-control select2', 'placeholder' => __('messages.please_select'), 'required', 'id' => 'transfer_location_id']); !!}
					</div>
				</div>
