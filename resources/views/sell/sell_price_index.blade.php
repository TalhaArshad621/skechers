...
<section class="content">
    ...
    @endif
    @component('components.widget', ['class' => 'box-primary', 'title' => __('Import Export Selling Price Update')])
            <div class="row">
                <div class="col-sm-6">
                    <a href="{{action('SellingPriceGroupController@export')}}" class="btn btn-primary">@lang('Export Sell Prices')</a>
                </div>
                <div class="col-sm-6">
                    {!! Form::open(['url' => action('SellController@importSellUpdatePrices'), 'method' => 'post', 'enctype' => 'multipart/form-data' ]) !!}
                    <div class="form-group">
                        {!! Form::label('name', __( 'product.file_to_import' ) . ':') !!}
                        {!! Form::file('product_sell_prices', ['required' => 'required']); !!}
                    </div>
                    <div class="form-group">
