...
<input type="hidden" id="item_addition_method" value="{{$business_details->item_addition_method}}">
	{!! Form::open(['url' => action('SellPosController@storeGift'), 'method' => 'post', 'id' => 'add_sell_form', 'files' => true ]) !!}
	<div class="row">
		<div class="col-md-12 col-sm-12">
			...
			@endcomponent
			<div>
				@component('components.widget', ['class' => 'box-solid', 'title' => __('Additional Information')])
					...
					<div class="col-md-4" style="display: none;"><br>
