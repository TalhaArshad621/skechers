@extends('layouts.app')
@section('title', __('product.add_product_adjustment'))
...
<br>
    <h1>@lang('product.add_product_adjustment')</h1>
    <!-- <ol class="breadcrumb">
...
<section class="content no-print">
	{!! Form::open(['url' => action('ProductAdjustmentController@store'), 'method' => 'post', 'id' => 'stock_adjustment_form' ]) !!}
			...
			<div class="row">
				...
				<div class="col-sm-3">
					<div class="form-group">
						...
						{!! Form::select('adjustment_type', [ 'in' =>  __('product.adjustment_in'), 'out' =>  __('product.adjustment_out')], null, ['class' => 'form-control select2', 'placeholder' => __('messages.please_select'), 'required']); !!}
					</div>
				</div>
			</div>
		</div>
...
@stop
@section('javascript')
	<script src="{{ asset('js/product_adjustment.js?v=' . $asset_v) }}"></script>
