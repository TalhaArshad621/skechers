    ...
    @component('components.widget', ['class' => 'box-primary'])
        ...
        <div class="col-md-9">
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'product.audit', in_array('product.audit', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'Add Product Audit' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'product.history', in_array('product.history', $role_permissions), 
        ...
        <div class="col-md-9">
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'stocktransfer.view', in_array('stocktransfer.view', $role_permissions), 
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'stocktransfer.create', in_array('stocktransfer.create', $role_permissions), 
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'stocktransfer.update', in_array('stocktransfer.update', $role_permissions), 
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'stocktransfer.delete', in_array('stocktransfer.delete', $role_permissions), 
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'stocktransfer.update_status', in_array('stocktransfer.update_status', $role_permissions),['class' => 'input-icheck']); !!}
                {{ __('lang_v1.update_status') }}
              </label>
            </div>
          </div>
        ...
        <div class="col-md-9">
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'view_gifts', in_array('view_gifts', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'View Gifts' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'add_gifts', in_array('add_gifts', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'Add Gifts' ) }}
              </label>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-9">
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'view_ecommerce', in_array('view_ecommerce', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'View Ecommerce' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'edit_ecommerce', in_array('edit_ecommerce', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'Update Ecommerce' ) }}
              </label>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-9">
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'view_international_exchange', in_array('view_international_exchange', $role_permissions), 
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'create_international_exchange', in_array('create_international_exchange', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'Add Ecommerce' ) }}
              </label>
            </div>
          </div>
        </div>
        ...
        @endif
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'overview_report.view', in_array('overview_report.view', $role_permissions), 
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'product_sell_detail_report.view',  in_array('product_sell_detail_report.view', $role_permissions), 
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'brand_folio_report.view',  in_array('brand_folio_report.view', $role_permissions), 
