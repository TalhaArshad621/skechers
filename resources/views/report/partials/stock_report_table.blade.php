<table class="table table-bordered table-striped" id="stock_report_table">
    <thead>
        <tr>
            ...
            <th>Sold Stock Value <br><small>(By purchase price)</small></th>
            <th>Sold Stock Value <br><small>(By sale price)</small></th>
    ...
    <tfoot>
        <tr class="bg-gray font-17 text-center footer-total">
            ...
            <td class="sold_stock_value_by_purchase_price"></td>
            <td class="sold_stock_value_by_sale_price"></td>
