...
class ImportStockTrasferController extends Controller
{
        /**
     * All Utils instance.
     *
    ...
    public function create()
    {
        ...
        return view('import_stock_transfer.create')
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            foreach ($imported_data as $key => $value) {
                ...
                if (empty($product_array['ref_no'])) {
                    $product_array['ref_no'] = $this->productUtil->generateReferenceNumber('stock_transfer', $ref_count);
                }
                ...
                //Product Quantity
                $product_quantity = trim($value[1]);

                if($product_quantity <= 0){
                    $is_valid =  false;
                    $error_msg = "Product quantity is required in row no. $row_no";
                    break;
                }
