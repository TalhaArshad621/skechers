$(document).ready(function () {
    ...
    $("select#location_id_new").change(function () {
        getProductSearchList($("#location_id_new").val());
    })
    ...
    function getProductSearchList(location_id) {
                ...
                .autocomplete({
                    ...
                    response: function (event, ui) {
                        if (ui.content.length == 1) {
                            ...
                            $('input#search_product_sell').select();
                        }
                    },
    ...
    $('#search_product_sell').keydown(function (e) {
        var key = e.which;
        if (key == 9) {
            // the tab key code
            e.preventDefault();
...
function returned_amount() {
    ...
    //     var unit_price = __read_number($(this).find('input.pos_unit_price_inc_tax'));
...
function isValidPosForm() {
    ...
    if ($('tr.product_row').length == 0) {
        ...
        $(error).insertAfter($('input#search_product_sell').parent('div'));
    }
...
function set_location() {
    ...
    if ($('input#location_id').val()) {
        ...
        $('input#search_product_sell').prop('disabled', true);
    }
